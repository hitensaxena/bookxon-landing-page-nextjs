...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="pt-16 pb-20 md:pt-24 md:pb-28 px-6 lg:px-8 relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        {/* Text Content */}
        <div ref={textContentRef} className="reveal-on-scroll text-center md:text-left">
