  ...
  return (
    <section id="feature-payment-detail" className="py-16 md:py-20 lg:py-24 px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
        {/* Image */}
        <div ref={imageRef} className="order-2 md:order-1 reveal-on-scroll" style={{ transitionDelay: '0.15s' }}>
          <Image
            src={IMAGE_URL}
        ...
        {/* Text Content */}
        <div ref={textContentRef} className="order-1 md:order-2 reveal-on-scroll">
          <span className="inline-block bg-bx-secondary text-gradient text-xs font-semibold px-3 py-1 rounded-full mb-3 uppercase tracking-wide">
            Cashflow Confidence
          </span>
