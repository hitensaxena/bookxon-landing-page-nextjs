  ...
  return (
    <div className="faq-item">
      <details ref={detailsRef} open={isOpen}>
        ...
        <div className="px-2 pb-6 pt-2 text-text-secondary text-sm leading-relaxed border-l-2 border-[var(--gradient-start)] ml-2">
          {answer}
        </div>
      </details>
    </div>
...
const FAQSection = () => {
  ...
  return (
    <section id="faq" className="py-20 md:py-28 lg:py-32 px-6 lg:px-8 bg-white">
      <div ref={sectionRef} className="max-w-3xl mx-auto reveal-on-scroll">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-5">Got Questions? <br /> <span className="text-gradient">We Have Answers.</span></h2>
