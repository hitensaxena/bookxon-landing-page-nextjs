...
const Footer = () => {
  ...
  return (
    <footer id="support" className="py-16 md:py-20 px-6 lg:px-8 bg-white border-t border-border-color"> {/* Added bg and border */}
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10 lg:gap-12 text-sm">
        {/* Column 1: Logo, Description, Social Links */}
        <div className="col-span-2 md:col-span-4 lg:col-span-2 mb-6 lg:mb-0 pr-8">
          <Link href="#hero" onClick={(e) => handleNavClick(e, '#hero')} className="text-3xl font-extrabold text-gradient">
            Crow
          </Link>
          <p className="mt-2 text-xs leading-relaxed mb-6 text-text-secondary"> {/* Added text color */}
